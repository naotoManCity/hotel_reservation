...
<div class="container w-50">
    <div class="row justify-content-center">
        ...
        <form method="" action="#">
            ...
            <input type="text" class="form-control" aria-describedby="emailHelp" placeholder="姓名">
            </div>
            <div class="mb-3">
                <label for="InputEmail1" class="form-label">メールアドレス<span class="text-white bg-danger rounded px-2 mx-1">必須</span></label>
                <input type="email" class="form-control" aria-describedby="emailHelp" placeholder="このメールアドレスにご返信します">
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <textarea name="content" id="content" class="form-control" placeholder="お問合わせ内容をご記入ください" rows="8"></textarea>
            </div>
